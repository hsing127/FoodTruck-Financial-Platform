...
export const ProductShowcase = () => {
  ...
  const rotateX = useTransform(scrollYProgress, [0, .8], [45, 0]);
    ...
    <div className="bg-black overflow-hidden text-white bg-gradient-to-b from-black to-[#5D2CA8] sm:py-24 py-[72px]">
      <div className="container relative">
        ...
        <div className="max-w-xl mx-auto">
          <p className="text-xl text-center text-white/70 mt-5">FoodTrack is a comprehensive platform designed
            to streamline financial management for food truck owners. From automating expense tracking to
        ...
        <motion.div
          ...
          <Image src={appScreen} priority alt="the Product Screenshot" className="mt-14" ref={appImg} />
        </motion.div>
      </div>
    </div>
  );
