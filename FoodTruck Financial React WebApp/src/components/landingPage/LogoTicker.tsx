  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24">
      <div className="container">
        ...
        <div className="overflow-hidden mt-9 before:content-[''] after:content-[''] before:absolute before:z-10 after:absolute before:h-full 
        ...
        before:bg-[linear-gradient(to_right,#000,rgb(0,0,0,0))] after:bg-[linear-gradient(to_left,#000,rgb(0,0,0,0))]">
          <motion.div
            ...
            transition={{ duration: tickerWidth / 200, ease: "linear", repeat: Infinity }} // Adjust the speed based on width
