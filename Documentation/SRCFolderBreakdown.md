...
│   │   │   ├── DashboardSettingsComponents     # Components for Dashboard Settings
│   │   │   │   ├── button.tsx                  # Button component for various actions.
│   │   │   │   ├── changePasswordModal.tsx     # Modal for changing the user's password.
│   │   │   │   ├── confirmModal.tsx            # Confirmation modal for delete or sensitive actions.
│   │   │   │   ├── deleteAccount.tsx           # Section for account deletion with confirmation modal.
│   │   │   │   ├── formInput.tsx               # Input component for forms.
│   │   │   │   ├── language.tsx                # Section for selecting language and currency.
│   │   │   │   ├── notifications.tsx           # Section for notification settings.
│   │   │   │   ├── profile.tsx                 # Section for profile management.
│   │   │   │   ├── profileModal.tsx            # Modal for editing user profile.
│   │   │   │   ├── sectionCard.tsx             # Card component for grouping dashboard sections.
│   │   │   │   ├── security.tsx                # Section for security settings.
│   │   │   │   ├── selectInput.tsx             # Dropdown select input component.
│   │   │   │   ├── settingsSection.tsx         # Component for displaying grouped settings.
│   │   │   │   ├── toggleSwitch.tsx            # Toggle switch component for enabling/disabling features.
