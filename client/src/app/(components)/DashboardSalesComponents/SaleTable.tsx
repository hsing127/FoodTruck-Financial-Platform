                ...
                <tr>
                  ...
                  <th className="text-left w-1/4 text-xs font-medium text-black uppercase tracking-wider">
                    <button
                      ...
                      onClick={() =>
                        handleActionItemClick(ActionType.FILTER, "Filter by StartDate")
                      }
                    >
                      Start Date
                      {sortField === "startDate" &&
                  ...
                  <th className="text-left w-1/4 text-xs font-medium text-black uppercase tracking-wider">
                    <button
                      className="flex items-center w-full text-left cursor-pointer"
                      onClick={() =>
                        handleActionItemClick(ActionType.FILTER, "Filter by EndDate")
                      }
                    >
                      End Date
                      {sortField === "endDate" &&
                  ...
                  <th className="text-left w-1/4 text-xs font-medium text-black uppercase tracking-wider">
                    <button
                      className="flex items-center w-full text-left cursor-pointer"
                      onClick={() =>
                        handleActionItemClick(ActionType.FILTER, "Filter by Revenue")
                      }
                    >
                      Revenue
                      {sortField === "revenue" &&
